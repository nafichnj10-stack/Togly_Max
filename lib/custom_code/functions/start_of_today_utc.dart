...
DateTime startOfTodayUtc() {
  // Create a Dart custom function called startOfTodayUtc with no arguments and a non-nullable DateTime return type. The function should take the current UTC time, strip hours, minutes, seconds, and milliseconds, and return the DateTime object representing the start of the current day in UTC.
