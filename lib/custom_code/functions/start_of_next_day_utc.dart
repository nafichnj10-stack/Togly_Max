...
DateTime startOfNextDayUtc(DateTime dt) {
  final localStart = DateTime(dt.year, dt.month, dt.day);
  final nextDay = localStart.add(const Duration(days: 1));
  return nextDay.toUtc();
}
