...
String? formatPartnerSurprisesText(
  int? count,
  String? language,
) {
...
// ENGLISH
  if (lang == 'en') {
    if (count == 1) {
      return 'Your partner prepared 1 surprise';
    }
    return 'Your partner prepared $count surprises';
  }

// GERMAN
  if (lang == 'de') {
    if (count == 1) {
      return 'Dein Partner hat 1 Überraschung vorbereitet';
    }
    return 'Dein Partner hat $count Überraschungen vorbereitet';
  }

// SPANISH
  if (lang == 'es') {
    if (count == 1) {
      return 'Tu pareja preparó 1 sorpresa';
    }
    return 'Tu pareja preparó $count sorpresas';
  }
