...
DateTime startOfTomorrowUtc() {
  // Create a Dart custom function called startOfTomorrowUtc with no arguments and a non-nullable DateTime return type. The function should calculate the start of the current day in UTC (using the same logic as startOfTodayUtc) and then return a DateTime object for exactly 24 hours later (the start of tomorrow in UTC).
  final todayStart = startOfTodayUtc();
  return todayStart.add(Duration(days: 1));
}
