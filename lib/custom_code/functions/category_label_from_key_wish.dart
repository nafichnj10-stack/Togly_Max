...
String categoryLabelFromKeyWish(String? categoryKey) {
  // ---------- Language ----------
  String lang = 'en';
  try {
  ...
  // ---------- Normalize key ----------
  final k = (categoryKey ?? '').toString().trim().toLowerCase();
  ...
  // ---------- Wish category labels ----------
  switch (k) {
    case 'relationship':
      return t(en: '💞 Relationship', de: '💞 Beziehung', es: '💞 Relación');

    case 'gift':
      return t(en: '🎁 Gift', de: '🎁 Geschenk', es: '🎁 Regalo');

    case 'experience':
      return t(en: '✨ Experience', de: '✨ Erleben', es: '✨ Experiencia');

    case 'travel':
      return t(en: '🌍 Travel', de: '🌍 Reisen', es: '🌍 Viajes');

    case 'adventure':
      return t(en: '🧭 Adventure', de: '🧭 Abenteuer', es: '🧭 Aventura');

    case 'food':
      return t(en: '🍽️ Food', de: '🍽️ Essen', es: '🍽️ Comida');

    case 'pet':
      return t(en: '🐾 Pet', de: '🐾 Haustier', es: '🐾 Mascota');

    case 'clothing':
      return t(en: '🏷️ Clothing', de: '🏷️ Kleidung', es: '🏷️ Ropa');

    case 'jewelry':
      return t(en: '💍 Jewelry', de: '💍 Schmuck', es: '💍 Joyería');
