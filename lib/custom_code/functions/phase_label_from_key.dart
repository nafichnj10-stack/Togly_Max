...
String phaseLabelFromKey(String? phaseKey) {
  // language
  String lang = 'en';
  try {
  ...
  final k = (phaseKey ?? '').trim().toLowerCase();

  switch (k) {
    case 'planning':
      return t(en: 'Planning', de: 'In Planung', es: 'En planificación');
    case 'in_progress':
      return t(en: 'In progress', de: 'In Arbeit', es: 'En progreso');
    case 'saving_up':
      return t(en: 'Saving up', de: 'Ansparen', es: 'Ahorrando');
    case 'someday':
      return t(en: 'Someday', de: 'Eines Tages', es: 'Algún día');
    default:
      // fallback
      return t(en: 'Planning', de: 'In Planung', es: 'En planificación');
  }
