...
import 'goal_actions_model.dart';
export 'goal_actions_model.dart';
...
class GoalActionsWidget extends StatefulWidget {
  const GoalActionsWidget({
    super.key,
    required this.goalRef,
    this.storagePath,
  });

  final BucketListRecord? goalRef;
  final String? storagePath;

  @override
  State<GoalActionsWidget> createState() => _GoalActionsWidgetState();
}

class _GoalActionsWidgetState extends State<GoalActionsWidget> {
  late GoalActionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GoalActionsModel());
                        ...
                        onPressed: () async {
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Delete goal from archive'),
                                    content: Text(
                                        'This will remove the goal and its photo. Continue?'),
                                    actions: [
                                      TextButton(
                          ...
                          if (confirmDialogResponse) {
                            if (widget.goalRef?.imageUrl != null &&
                                widget.goalRef?.imageUrl != '') {
                              ...
                              await widget.goalRef!.reference.delete();
