...
import 'edit_goal_sheet_widget.dart' show EditGoalSheetWidget;
import 'package:flutter/material.dart';

class EditGoalSheetModel extends FlutterFlowModel<EditGoalSheetWidget> {
  ...
  String? _textFieldtitleTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'v56re5zd' /* Enter your dream goal... is re... */,
      );
    }
  ...
  String? _textFieldnoteTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ymndcvum' /* Add details about your goal...... */,
      );
    }
  ...
  SendPartnerPushCloudFunctionCallResponse? cloudFunction88i;
