...
void main() async {
  ...
  final firebase_storagelibrary_2sa6k9AppState =
      firebase_storagelibrary_2sa6k9_app_state.FFAppState();
  await firebase_storagelibrary_2sa6k9AppState.initializePersistedState();
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(
        create: (context) => firebase_storagelibrary_2sa6k9AppState,
      ),
    ],
    child: MyApp(),
  ));
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = togly20FirebaseUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'Together': TogetherWidget(),
      'LoveNotePage': LoveNotePageWidget(),
