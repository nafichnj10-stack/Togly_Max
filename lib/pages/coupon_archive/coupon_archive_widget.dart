...
import 'coupon_archive_model.dart';
export 'coupon_archive_model.dart';
...
class CouponArchiveWidget extends StatefulWidget {
  const CouponArchiveWidget({
    super.key,
  ...
  static String routeName = 'coupon_archive';
  static String routePath = '/coupon_archive';

  @override
  State<CouponArchiveWidget> createState() => _CouponArchiveWidgetState();
}

class _CouponArchiveWidgetState extends State<CouponArchiveWidget> {
  late CouponArchiveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CouponArchiveModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'coupon_archive'});
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              '980b7qc8' /* Redeemed Love Coupons */,
                            ),
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              'ypkoodtv' /* A collection of every coupon y... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
