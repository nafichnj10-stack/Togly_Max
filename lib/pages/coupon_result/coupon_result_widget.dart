...
import 'coupon_result_model.dart';
export 'coupon_result_model.dart';
...
class CouponResultWidget extends StatefulWidget {
  const CouponResultWidget({
    super.key,
  ...
  static String routeName = 'coupon_result';
  static String routePath = '/coupon_result';

  @override
  State<CouponResultWidget> createState() => _CouponResultWidgetState();
}

class _CouponResultWidgetState extends State<CouponResultWidget> {
  late CouponResultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CouponResultModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'coupon_result'});
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              '0nkyek42' /* Redeemed Love Coupons */,
                            ),
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              'pws9oqzw' /* A collection of every coupon y... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
